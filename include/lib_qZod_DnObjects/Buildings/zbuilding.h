...
#include <algorithm>
#include <lib_qZod_DnEffect/estandard.h>
...
class QZOD_DNOBJECTSSHARED_EXPORT ZBProductionUnit
{
public:
...
class QZOD_DNOBJECTSSHARED_EXPORT ZBuilding : public ZObject
{
	public:
		ZBuilding(ZTime *ztime_, ZSettings *zsettings_ = nullptr, planet_type palette_ = DESERT);
		~ZBuilding();
