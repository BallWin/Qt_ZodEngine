#ifndef ZGWFACTORY_LIST_H
#define ZGWFACTORY_LIST_H
...
class QZOD_DNOBJECTSSHARED_EXPORT gwfl_render_entry
{
public:
...
class QZOD_DNOBJECTSSHARED_EXPORT GWFactoryList : public ZGuiWindow
{
public:
