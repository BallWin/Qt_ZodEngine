#ifndef QZOD_SETTINGS_OLD_H
#define QZOD_SETTINGS_OLD_H

#include "qzod_dnsettings_global.h"

#pragma pack(1)

class QZOD_DNSETTINGSSHARED_EXPORT ZUnit_Settings
{
public:
    ZUnit_Settings()
    {
...
class QZOD_DNSETTINGSSHARED_EXPORT ZSettings
{
public:
    ZSettings();
    void SetDefaults();
