#ifndef QZOD_SOUNDENGINE_OLD_H
#define QZOD_SOUNDENGINE_OLD_H
...
// -- default folder name for sounds
#ifndef DEF_SOUND_FOLDER
#define DEF_SOUND_FOLDER    "assets/sounds"
#endif
...
class QZOD_DNSOUNDENGINESHARED_EXPORT ZSound
{
public:
    ZSound();
    ZSound(std::string folder_sound);

    void set_folder_sound_files(std::string folder_sound);
    std::string get_folder_sound_files(){ return _folder_sound_files;}
    ...
    int volume_shift;
    int repeat_channel;
    std::string _folder_sound_files;
};

class QZOD_DNSOUNDENGINESHARED_EXPORT ZSoundEngine
{
    public:
        ZSoundEngine();
