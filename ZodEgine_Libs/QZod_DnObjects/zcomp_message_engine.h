#ifndef ZCOMP_MESSAGE_ENGINE_H
#define ZCOMP_MESSAGE_ENGINE_H
...
class QZOD_DNOBJECTSSHARED_EXPORT comp_msg_flags
{
public:
...
class QZOD_DNOBJECTSSHARED_EXPORT ZCompMessageEngine
{
public:
	ZCompMessageEngine();
