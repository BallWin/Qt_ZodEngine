...
class QZOD_DNOBJECTSSHARED_EXPORT ABird : public ZObject
{
	public:
		ABird(ZTime *ztime_, ZSettings *zsettings_ = nullptr, planet_type palette_ = DESERT, int map_w_ = 0, int map_h_ = 0);
