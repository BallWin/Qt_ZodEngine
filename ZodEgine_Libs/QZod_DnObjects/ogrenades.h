...
#include <lib_qZod_DnEffect/eturrentmissile.h>
#include "zobject.h"

class QZOD_DNOBJECTSSHARED_EXPORT OGrenades : public ZObject
{
	public:
		OGrenades(ZTime *ztime_, ZSettings *zsettings_ = nullptr);
