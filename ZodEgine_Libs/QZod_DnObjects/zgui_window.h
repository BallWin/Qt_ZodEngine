...
#include "Buildings/zbuildlist.h"
#include "zobject.h"


class QZOD_DNOBJECTSSHARED_EXPORT gui_flags
{
public:
    gui_flags(){ Clear(); }
...
class QZOD_DNOBJECTSSHARED_EXPORT ZGuiButton
{
	public:
		ZGuiButton();
...
class QZOD_DNOBJECTSSHARED_EXPORT ZGuiScrollBar
{
public:
	ZGuiScrollBar();
...
class QZOD_DNOBJECTSSHARED_EXPORT ZGuiTextBox
{
public:
	ZGuiTextBox();
...
class QZOD_DNOBJECTSSHARED_EXPORT ZGuiWindow
{
	public:
		...
		virtual ZObject *GetBuildingObj() { return nullptr; }
