#ifndef CMISSILECANNON_H
#define CMISSILECANNON_H

#include "zcannon.h"
#include <lib_qZod_DnEffect/emissilecrockets.h>

class QZOD_DNOBJECTSSHARED_EXPORT CMissileCannon : public ZCannon
{
	public:
		CMissileCannon(ZTime *ztime_, ZSettings *zsettings_ = nullptr, bool just_placed = false);
