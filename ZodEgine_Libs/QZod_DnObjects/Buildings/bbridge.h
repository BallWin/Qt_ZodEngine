...
class QZOD_DNOBJECTSSHARED_EXPORT BBridge : public ZBuilding
{
public:
	BBridge(ZTime *ztime_, ZSettings *zsettings_ = nullptr, planet_type palette_ = DESERT, bool is_vertical_ = true, unsigned short extra_links_ = 0);
	~BBridge();
